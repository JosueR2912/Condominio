...
-- Tiempo de generación: 09-06-2023 a las 18:11:41
...
--
-- Estructura de tabla para la tabla `public_apartamento`
--

DROP TABLE IF EXISTS `public_apartamento`;
CREATE TABLE IF NOT EXISTS `public_apartamento` (
  `id_public_apartamento` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `numero` int DEFAULT NULL,
  `piso` int DEFAULT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `id_public_habitante` int UNSIGNED DEFAULT NULL,
  `id_public_condominio` int UNSIGNED DEFAULT NULL,
  PRIMARY KEY (`id_public_apartamento`),
  KEY `fk_public_apartamento_public_habitante` (`id_public_habitante`),
  KEY `fk_public_apartamento_public_condominio` (`id_public_condominio`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `public_apartamento`
--

INSERT INTO `public_apartamento` (`id_public_apartamento`, `numero`, `piso`, `status_eliminado`, `id_public_habitante`, `id_public_condominio`) VALUES
(1, 1, 1, 'Eliminado', 1, 1),
(2, 2, 1, 'Eliminado', 2, 1);
...
--
-- Estructura de tabla para la tabla `public_condominio`
--

DROP TABLE IF EXISTS `public_condominio`;
CREATE TABLE IF NOT EXISTS `public_condominio` (
  `id_public_condominio` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `rif` int DEFAULT NULL,
  `nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cantidad_apartamento` int DEFAULT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `numero_pisos` int DEFAULT NULL,
  `public_estado_id` int NOT NULL,
  `public_ciudad_id` int NOT NULL,
  `public_municipio_id` int NOT NULL,
  `public_parroquia_id` int NOT NULL,
  `descripcion` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `id_public_fondo_reserva` int UNSIGNED DEFAULT NULL,
  `id_public_users` int UNSIGNED DEFAULT NULL,
  PRIMARY KEY (`id_public_condominio`),
  UNIQUE KEY `rif` (`rif`),
  KEY `fk_public_condominio_public_fondo_reserva` (`id_public_fondo_reserva`),
  KEY `fk_public_condominio_public_users` (`id_public_users`),
  KEY `fk_public_condominio_public_ciudades` (`public_ciudad_id`),
  KEY `fk_public_condominio_public_municipio` (`public_municipio_id`),
  KEY `fk_public_condominio_public_parroquias` (`public_parroquia_id`),
  KEY `fk_public_condominio_public_estados` (`public_estado_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `public_condominio`
--

INSERT INTO `public_condominio` (`id_public_condominio`, `rif`, `nombre`, `cantidad_apartamento`, `status_eliminado`, `numero_pisos`, `public_estado_id`, `public_ciudad_id`, `public_municipio_id`, `public_parroquia_id`, `descripcion`, `id_public_fondo_reserva`, `id_public_users`) VALUES
(1, 12484186, 'Condominios El Prexel', 10, 'Eliminado', 5, 12, 212, 146, 464, 'pp', 1, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `public_factura`
--

DROP TABLE IF EXISTS `public_factura`;
CREATE TABLE IF NOT EXISTS `public_factura` (
  `id_public_factura` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `id_public_condominio` int UNSIGNED DEFAULT NULL,
  `id_public_servicios` int UNSIGNED DEFAULT NULL,
  `id_public_gastos` int UNSIGNED DEFAULT NULL,
  `total` double DEFAULT NULL,
  `iva` double DEFAULT NULL,
  `descuento` double DEFAULT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id_public_factura`),
  KEY `fk_public_factura_public_condominio` (`id_public_condominio`),
  KEY `fk_public_factura_public_servicios` (`id_public_servicios`),
  KEY `fk_public_factura_public_gastos` (`id_public_gastos`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `public_fondo_reserva`
--

DROP TABLE IF EXISTS `public_fondo_reserva`;
CREATE TABLE IF NOT EXISTS `public_fondo_reserva` (
  `id_public_fondo_reserva` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `monto_bs` double DEFAULT NULL,
  `ingreso_bs` double DEFAULT NULL,
  `egreso_bs` double DEFAULT NULL,
  `monto_dollar` double NOT NULL,
  `ingreso_dollar` double NOT NULL,
  `egreso_dollar` double NOT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id_public_fondo_reserva`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `public_fondo_reserva`
--

INSERT INTO `public_fondo_reserva` (`id_public_fondo_reserva`, `monto_bs`, `ingreso_bs`, `egreso_bs`, `monto_dollar`, `ingreso_dollar`, `egreso_dollar`, `status_eliminado`) VALUES
(1, 100, 0, 0, 200, 0, 0, 'Eliminado'),
(2, 200, 0, 0, 100, 0, 0, 'Eliminado');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `public_gastos`
--

DROP TABLE IF EXISTS `public_gastos`;
CREATE TABLE IF NOT EXISTS `public_gastos` (
  `id_public_gastos` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `monto` double DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `id_public_condominio` int UNSIGNED NOT NULL,
  `id_public_registro_gastos` int UNSIGNED NOT NULL,
  PRIMARY KEY (`id_public_gastos`),
  KEY `id_public_condominio` (`id_public_condominio`),
  KEY `fk_public_gastos_public_registro_gastos` (`id_public_registro_gastos`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `public_gastos`
--

INSERT INTO `public_gastos` (`id_public_gastos`, `nombre`, `monto`, `fecha`, `status_eliminado`, `id_public_condominio`, `id_public_registro_gastos`) VALUES
(4, 'Bolsas de basura', 100, '2023-05-24', 'Eliminado', 1, 3);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `public_habitante`
--

DROP TABLE IF EXISTS `public_habitante`;
CREATE TABLE IF NOT EXISTS `public_habitante` (
  `id_public_habitante` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tipo_cedula` enum('V','E','J') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `cedula` int DEFAULT NULL,
  `correo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `linea_telefono` enum('0424','0412','0251','0416','0426','0414') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `telefono` int DEFAULT NULL,
  `status` enum('Propietario','Inquilino') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `username` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `password` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id_public_habitante`),
  UNIQUE KEY `cedula` (`cedula`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `public_habitante`
--

INSERT INTO `public_habitante` (`id_public_habitante`, `nombre`, `apellido`, `tipo_cedula`, `cedula`, `correo`, `linea_telefono`, `telefono`, `status`, `status_eliminado`, `username`, `password`) VALUES
(1, 'Drexel', 'Colmenarez', 'V', 27868982, 'Colmenarez.drexel@gmail.com', '0424', 5344033, 'Propietario', 'Eliminado', NULL, NULL),
(2, 'Josue', 'Ramirez', 'V', 27868983, 'Correodejosue@gmail.com', '0416', 2548656, 'Propietario', 'Eliminado', NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `public_registro_de_fondo`
--

DROP TABLE IF EXISTS `public_registro_de_fondo`;
CREATE TABLE IF NOT EXISTS `public_registro_de_fondo` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `monto_bs` double DEFAULT NULL,
  `monto_dollar` double NOT NULL,
  `fondo_reserva_id` int UNSIGNED DEFAULT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_public_registro_de_fondo_public_fondo_reserva` (`fondo_reserva_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `public_registro_de_pagos`
--

DROP TABLE IF EXISTS `public_registro_de_pagos`;
CREATE TABLE IF NOT EXISTS `public_registro_de_pagos` (
  `id_public_registro_de_pagos` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `tipo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `monto` double DEFAULT NULL,
  `total` double DEFAULT NULL,
  `concepto` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `banco` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `id_public_apartamento` int UNSIGNED DEFAULT NULL,
  `id_public_tasa_dia` int UNSIGNED DEFAULT NULL,
  `id_public_factura` int UNSIGNED DEFAULT NULL,
  `id_public_habitante` int UNSIGNED DEFAULT NULL,
  PRIMARY KEY (`id_public_registro_de_pagos`),
  KEY `fk_public_registro_de_pagos_public_apartamento` (`id_public_apartamento`),
  KEY `fk_public_registro_de_pagos_public_tasa_dia` (`id_public_tasa_dia`),
  KEY `fk_public_registro_de_pagos_public_factura` (`id_public_factura`),
  KEY `fk_public_registro_de_pagos_public_habitante` (`id_public_habitante`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `public_registro_gastos`
--

DROP TABLE IF EXISTS `public_registro_gastos`;
CREATE TABLE IF NOT EXISTS `public_registro_gastos` (
  `id_public_registro_gastos` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `monto` double DEFAULT NULL,
  `fecha` timestamp NULL DEFAULT NULL,
  `status` enum('Pagado','Pendiente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `cancelado_bs` double NOT NULL,
  `cancelado_dollar` double NOT NULL,
  `id_tasa_dia` int UNSIGNED NOT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id_public_registro_gastos`),
  KEY `id_tasa_dia` (`id_tasa_dia`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `public_registro_gastos`
--

INSERT INTO `public_registro_gastos` (`id_public_registro_gastos`, `nombre`, `monto`, `fecha`, `status`, `cancelado_bs`, `cancelado_dollar`, `id_tasa_dia`, `status_eliminado`) VALUES
(3, 'Bolsas de basura', 10, '2023-05-18 00:41:12', 'Pagado', 270, 0, 1, 'Eliminado');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `public_registro_servicio`
--

DROP TABLE IF EXISTS `public_registro_servicio`;
CREATE TABLE IF NOT EXISTS `public_registro_servicio` (
  `id_public_registro_servicio` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `monto` double DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `status` enum('Pagado','Pendiente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `cancelado_dollar` double NOT NULL,
  `id_tasa_dia` int UNSIGNED NOT NULL,
  PRIMARY KEY (`id_public_registro_servicio`),
  KEY `fk_public_registro_servicio_public_tasa_dia` (`id_tasa_dia`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `public_registro_servicio`
--

INSERT INTO `public_registro_servicio` (`id_public_registro_servicio`, `nombre`, `monto`, `fecha`, `status`, `status_eliminado`, `cancelado_bs`, `cancelado_dollar`, `id_tasa_dia`) VALUES
(1, 'Luz', 100, '2023-05-16', 'Pagado', 'Eliminado', 0, 100, 1),
(2, 'Agua', 50, '2023-05-17', 'Pendiente', 'Eliminado', 0, 0, 1),
(3, 'luz', 100, '0000-00-00', 'Pagado', 'Eliminado', 100, 0, 1);
...
DROP TABLE IF EXISTS `public_servicios`;
CREATE TABLE IF NOT EXISTS `public_servicios` (
  `id_public_servicios` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `monto` double DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `id_public_condominio` int UNSIGNED NOT NULL,
  `id_public_registro_servicio` int UNSIGNED NOT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id_public_servicios`),
  KEY `fk_public_servicios_public_registro_servicios` (`id_public_registro_servicio`),
  KEY `fk_public_servicios_public_condominio` (`id_public_condominio`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `public_servicios`
--

INSERT INTO `public_servicios` (`id_public_servicios`, `nombre`, `monto`, `fecha`, `id_public_condominio`, `id_public_registro_servicio`, `status_eliminado`) VALUES
(1, 'Luz', NULL, '0000-00-00', 1, 2, 'Eliminado');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `public_tasa_dia`
--

DROP TABLE IF EXISTS `public_tasa_dia`;
CREATE TABLE IF NOT EXISTS `public_tasa_dia` (
  `id_public_tasa_dia` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `precio_bcv` double DEFAULT NULL,
  `precio_dollar` double DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id_public_tasa_dia`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `public_tasa_dia`
--

INSERT INTO `public_tasa_dia` (`id_public_tasa_dia`, `precio_bcv`, `precio_dollar`, `fecha`, `status_eliminado`) VALUES
(1, 27, 1, '2023-05-29', 'Eliminado'),
(2, 28, 1, '2023-05-29', 'Eliminado'),
(3, 10, 1, '0000-00-00', 'Eliminado');
...
CREATE TABLE IF NOT EXISTS `public_users` (
  `id_public_users` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tipo_usuario` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `username` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `password` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_eliminado` enum('Eliminado','Existente') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id_public_users`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `public_users` (`id_public_users`, `nombre`, `apellido`, `tipo_usuario`, `username`, `password`, `status_eliminado`) VALUES
(1, 'Drexel', 'Colmenarez', 'tipo1', 'DrexelColmenarez', '123456', 'Eliminado'),
(2, 'usuario1', 'apellido1', 'tipo_1', 'test', '123465', 'Eliminado'),
(3, 'usuario2', 'apellido2', 'tipo_2', 'test2', '123465', 'Eliminado');
...
--
-- Filtros para la tabla `public_apartamento`
--
ALTER TABLE `public_apartamento`
  ADD CONSTRAINT `fk_public_apartamento_public_condominio` FOREIGN KEY (`id_public_condominio`) REFERENCES `public_condominio` (`id_public_condominio`),
  ADD CONSTRAINT `fk_public_apartamento_public_habitante` FOREIGN KEY (`id_public_habitante`) REFERENCES `public_habitante` (`id_public_habitante`);

--
-- Filtros para la tabla `public_condominio`
--
ALTER TABLE `public_condominio`
  ADD CONSTRAINT `fk_public_condominio_public_ciudades` FOREIGN KEY (`public_ciudad_id`) REFERENCES `ciudades` (`id_ciudad`),
  ADD CONSTRAINT `fk_public_condominio_public_estados` FOREIGN KEY (`public_estado_id`) REFERENCES `estados` (`id_estado`),
  ADD CONSTRAINT `fk_public_condominio_public_fondo_reserva` FOREIGN KEY (`id_public_fondo_reserva`) REFERENCES `public_fondo_reserva` (`id_public_fondo_reserva`),
  ADD CONSTRAINT `fk_public_condominio_public_municipio` FOREIGN KEY (`public_municipio_id`) REFERENCES `municipios` (`id_municipio`),
  ADD CONSTRAINT `fk_public_condominio_public_parroquias` FOREIGN KEY (`public_parroquia_id`) REFERENCES `parroquias` (`id_parroquia`),
  ADD CONSTRAINT `fk_public_condominio_public_users` FOREIGN KEY (`id_public_users`) REFERENCES `public_users` (`id_public_users`);

--
-- Filtros para la tabla `public_factura`
--
ALTER TABLE `public_factura`
  ADD CONSTRAINT `fk_public_factura_public_condominio` FOREIGN KEY (`id_public_condominio`) REFERENCES `public_condominio` (`id_public_condominio`),
  ADD CONSTRAINT `fk_public_factura_public_gastos` FOREIGN KEY (`id_public_gastos`) REFERENCES `public_gastos` (`id_public_gastos`),
  ADD CONSTRAINT `fk_public_factura_public_servicios` FOREIGN KEY (`id_public_servicios`) REFERENCES `public_servicios` (`id_public_servicios`);

--
-- Filtros para la tabla `public_gastos`
--
ALTER TABLE `public_gastos`
  ADD CONSTRAINT `fk_public_gastos_public_condominio` FOREIGN KEY (`id_public_condominio`) REFERENCES `public_condominio` (`id_public_condominio`),
  ADD CONSTRAINT `fk_public_gastos_public_registro_gastos` FOREIGN KEY (`id_public_registro_gastos`) REFERENCES `public_registro_gastos` (`id_public_registro_gastos`);

--
-- Filtros para la tabla `public_registro_de_fondo`
--
ALTER TABLE `public_registro_de_fondo`
  ADD CONSTRAINT `fk_public_registro_de_fondo_public_fondo_reserva` FOREIGN KEY (`fondo_reserva_id`) REFERENCES `public_fondo_reserva` (`id_public_fondo_reserva`);

--
-- Filtros para la tabla `public_registro_de_pagos`
--
ALTER TABLE `public_registro_de_pagos`
  ADD CONSTRAINT `fk_public_registro_de_pagos_public_apartamento` FOREIGN KEY (`id_public_apartamento`) REFERENCES `public_apartamento` (`id_public_apartamento`),
  ADD CONSTRAINT `fk_public_registro_de_pagos_public_factura` FOREIGN KEY (`id_public_factura`) REFERENCES `public_factura` (`id_public_factura`),
  ADD CONSTRAINT `fk_public_registro_de_pagos_public_habitante` FOREIGN KEY (`id_public_habitante`) REFERENCES `public_habitante` (`id_public_habitante`),
  ADD CONSTRAINT `fk_public_registro_de_pagos_public_tasa_dia` FOREIGN KEY (`id_public_tasa_dia`) REFERENCES `public_tasa_dia` (`id_public_tasa_dia`);

--
-- Filtros para la tabla `public_registro_gastos`
--
ALTER TABLE `public_registro_gastos`
  ADD CONSTRAINT `fk_public_registro_gastos_public_tasa_dia` FOREIGN KEY (`id_tasa_dia`) REFERENCES `public_tasa_dia` (`id_public_tasa_dia`);

--
-- Filtros para la tabla `public_registro_servicio`
--
ALTER TABLE `public_registro_servicio`
  ADD CONSTRAINT `fk_public_registro_servicio_public_tasa_dia` FOREIGN KEY (`id_tasa_dia`) REFERENCES `public_tasa_dia` (`id_public_tasa_dia`);

--
-- Filtros para la tabla `public_servicios`
--
ALTER TABLE `public_servicios`
  ADD CONSTRAINT `fk_public_servicios_public_condominio` FOREIGN KEY (`id_public_condominio`) REFERENCES `public_condominio` (`id_public_condominio`),
  ADD CONSTRAINT `fk_public_servicios_public_registro_servicios` FOREIGN KEY (`id_public_registro_servicio`) REFERENCES `public_registro_servicio` (`id_public_registro_servicio`);
COMMIT;
